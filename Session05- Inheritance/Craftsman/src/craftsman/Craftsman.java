...
public class Craftsman {
    ...
    //cô giáo yêu cầu sắp xếp các hình tăng dần theeo diện tích
    //dễ vì đã học
    //kho vì éo làm đc: vì ko học bài, vì...
    //mún sắp xếp thì phải vào mảng thì ta mới sort tự động, vì kích thước hình
